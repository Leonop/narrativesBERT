...
SELECTED_COLS = ['companyid', 'gvkey', 'mostimportantdateutc', 'componentorder', 'transcriptcomponenttypename', 'transcriptid', 'speakertypeid', 'componenttext', 'word_count', 'year', 'isdelayed_flag']
...
YEAR_FILTER = 2016 # train the model on data from start year to this year
...
SEED_WORDS : Dict[str, List[str]] = {
    ...
    "Economic forecast": ["economic forecast", "macroeconomic outlook", "economic projections", "economic trends", "economic expectations", "bernanke",
    ...
    "automation": ["automation", "robotics", "RPA", "robotic process automation", "artificial intelligence", "machine learning", "process automat", "digital transformation", "digitalization", "digit process automat", "autonomous driv", "autonomous vehicle", "autonomous system"],
