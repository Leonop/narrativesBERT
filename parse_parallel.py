# Author: Zicheng Xiao
# Date: 2024-10-26
# Description: This script is used to preprocess the earnings call data in multiprocess.
...
Main differences are 1) using Pool.starmap in process_largefile and 
2) attach to local CoreNLP server in process_largefile.process_document
"""
import datetime
import itertools
import os
