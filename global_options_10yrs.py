...
N_NEIGHBORS = [20] # Number of Neighbors in UMAP, the higher number requires more computational power
...
MIN_CLUSTER_SIZE = [36] # A large value will lead to larger, more stable clusters, but fewer clusters.
