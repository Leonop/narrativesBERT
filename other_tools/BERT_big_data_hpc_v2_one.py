...
# This is the version 2. In this version, I already used model selection script to find the optimal number of topics in the earnings calls.
# The optimal number of topic K is 110.
# Updated Details: removing 10-fold cross validation
# @todo I will add online LDA in the newer version
